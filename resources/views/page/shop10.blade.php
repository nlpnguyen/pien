...
@section('content')
    <div id="content" class="site-content" tabindex="-1">
        <div class="container">
            ...
            <nav class="woocommerce-breadcrumb"><a href="<?php echo route('page.home') ?>">Home</a><span class="delimiter"><i class="fa fa-angle-right"></i></span>{{$danhmuclist[9]->ten_danh_muc_san_pham}}</nav>
            ...
            <div id="primary" class="content-area">
                <main id="main" class="site-main">
                    ...
                    <header class="page-header">
                        <h1 class="page-title">{{$danhmuclist[9]->ten_danh_muc_san_pham}}</h1>
                    </header>
