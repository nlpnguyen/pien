                    ...
                    <div class="product">
                        <div class="single-product-wrapper">
                                ...
                                <div class="images electro-gallery">
                                    <div class="thumbnails-single owl-carousel owl-loaded owl-drag">
                                        <div class="owl-stage-outer">
                                            <div class="owl-stage"
                                                 style="transform: translate3d(0px, 0px, 0px); transition: all 0s ease 0s; width: 2820px;">
                                                <div class="owl-item active" style="width: 470px;"><a
                                                        href="assets/images/single-product/s1-1.jpg" class="zoom"
                                                        title="" data-rel="prettyPhoto[product-gallery]">
                                                        <img src="{{url($spct->images_san_pham)}}"
                                                             class="wp-post-image" alt="">
                                                    </a>
                                                </div>
                                                <div class="owl-item" style="width: 470px;"><a
                                                        href="assets/images/single-product/s1.jpg" class="zoom" title=""
                                                        data-rel="prettyPhoto[product-gallery]">
                                                        <img src="assets/images/single-product/s1.jpg"
                                                             class="wp-post-image" alt="">
                                                    </a></div>
                                                <div class="owl-item" style="width: 470px;"><a
                                                        href="assets/images/single-product/s2.jpg" class="zoom" title=""
                                                        data-rel="prettyPhoto[product-gallery]">
                                                        <img src="assets/images/single-product/s2.jpg"
                                                             class="wp-post-image" alt="">
                                                    </a></div>
                                                <div class="owl-item" style="width: 470px;"><a
                                                        href="assets/images/single-product/s3.jpg" class="zoom" title=""
                                                        data-rel="prettyPhoto[product-gallery]">
                                                        <img src="assets/images/single-product/s3.jpg"
                                                             class="wp-post-image" alt="">
                                                    </a></div>
                                                <div class="owl-item" style="width: 470px;"><a
                                                        href="assets/images/single-product/s4.jpg" class="zoom" title=""
                                                        data-rel="prettyPhoto[product-gallery]">
                                                        <img src="assets/images/blank.gif"
                                                             data-echo="assets/images/single-product/s4.jpg"
                                                             class="wp-post-image" alt="">
                                                    </a></div>
                                                <div class="owl-item" style="width: 470px;"><a
                                                        href="assets/images/single-product/s5.jpg" class="zoom" title=""
                                                        data-rel="prettyPhoto[product-gallery]">
                                                        <img src="assets/images/blank.gif"
                                                             data-echo="assets/images/single-product/s5.jpg"
                                                             class="wp-post-image" alt="">
                                                    </a></div>
                                            </div>
                                        </div>
                                    ...
                                    <div class="thumbnails-all columns-5 owl-carousel owl-loaded owl-drag">
                                        <div class="owl-stage-outer">
                                            <div class="owl-stage"
                                                 style="transform: translate3d(0px, 0px, 0px); transition: all 0s ease 0s; width: 574px;">
                                                @for($i=0;$i<count($act)-1;$i++)
                                                    @if($i==0)
                                                 <div class="owl-item active synced"
                                                     style="width: 87.6px; margin-right: 8px;">
                                                    <a
                                                        href=""
                                                         title="">
                                                        <img src="{{url($act[$i]->image)}}"
                                                             class="wp-post-image" alt="{!! $i !!}">
                                                    </a>
                            ...
                            <span class="loop-product-categories">
                                ...
                                <h1 itemprop="name" class="product_title entry-title">{{$spct->ten_san_pham}}</h1>
                                ...
                                <div itemprop="offers" itemscope="" itemtype="http://schema.org/Offer">
                                    ...
                                    <p class="price"><span class="electro-price"><ins><span
                                                    class="amount">$1,215.00</span></ins> <del><span class="amount">$2,299.00</span></del></span>
                                    </p>
                                        ...
                                        <tr>
                                            ...
                                            <td class="value">
                                                <select class="" name="attribute_pa_color">
                                                    ...
                                                    <option value="white-with-gold" selected="selected">White with
                                                        Gold
                                                    </option>
                                                </select>
                                    ...
                                    <div class="single_variation_wrap">
                                        ...
                                        <div class="woocommerce-variation-add-to-cart variations_button">
                                            ...
                                            <button  class="single_add_to_cart_button button">
                                                <a href="{{route('addcart',$spct->id)}}">Add to cart</a>
                                            </button>
				...
				<span class="total-price-html">
					<span class="amount">$1,424.00</span>
                                                ...
                                                <div class="accessories-add-all-to-cart">
                                                    <button type="button"
                                                            class="button btn btn-primary add-all-to-cart">Add all to
                                                        cart
                                                    </button>
                                ...
                                <div class="tab-pane active in panel entry-content wc-tab" id="tab-description">
                                    <div class="electro-description">
                                        ...
                                        <table class="layout">
                                            ...
                                            <tr>
                                                <td>
                                                    <h3>Wireless</h3>
                                                    <p>Fusce vitae nibh mi. Integer posuere, libero et ullamcorper
                                                        ...
                                                        ante et euismod.</p>
                                                    <h3>Fresh Design</h3>
                                                    <p>Integer bibendum aliquet ipsum, in ultrices enim sodales sed.
                                                        Quisque ut urna vitae lacus laoreet malesuada eu at massa.
                                                        Pellentesque nibh augue, pellentesque nec dictum vel, pretium a
                                                        arcu. Duis eu urna suscipit, lobortis elit quis, ullamcorper
                                                        massa.</p>
                                                    <h3>Fabolous Sound</h3>
                                                    <p>Cras rutrum, nibh a sodales accumsan, elit sapien ultrices
                                                ...
                                                <td>
                                                    <img class="alignright"
                                                         src="assets/images/single-product/ForDescription.jpg" alt="">
                                        ...
                                        <table class="layout">
                                            ...
                                            <tr>
                                                <td>
                                                    <img class="alignnone"
                                                         src="assets/images/single-product/ForDescription-1.png" alt="">
                                                </td>

                                                <td>
                                                    <h3 style="text-align: right;">Inteligent Bass</h3>
                                                    <p style="text-align: right;">Fusce vitae nibh mi. Integer posuere,
                                                        libero et ullamcorper facilisis, enim eros tincidunt orci, eget
                                                        vestibulum sapien nisi ut leo. Cras finibus vel est ut mollis.
                                                        Donec luctus condimentum ante et euismod.</p>
                                                    <h3 style="text-align: right;">Battery Life</h3>
                                                    <p style="text-align: right;">Integer bibendum aliquet ipsum, in
                                                        ultrices enim sodales sed. Quisque ut urna vitae lacus laoreet
                                                        malesuada eu at massa. Pellentesque nibh augue, pellentesque nec
                                                        dictum vel, pretium a arcu. Duis eu urna suscipit, lobortis elit
                                    ...
                                    <div class="product_meta">
                                        <span class="sku_wrapper">SKU: <span class="sku"
                                                                             itemprop="sku">FW511948218</span></span>
		...
		<a href="product-category.html" rel="tag">Gaming</a>, <a href="product-category.html" rel="tag">Strong</a>
                                                    ...
                                                    <div id="comment-390" class="comment_container">
                                                        ...
                                                        <div class="comment-text">
                                                            ...
                                                            <div itemprop="description" class="description">
                                                                <p>Fusce vitae nibh mi. Integer posuere, libero et
                                                                    ullamcorper facilisis, enim eros tincidunt orci,
                                                                    eget vestibulum sapien nisi ut leo. Cras finibus vel
                                                                    est ut mollis. Donec luctus condimentum ante et
                                                                    euismod.
                                                                </p>
                                                            </div>
                                                    ...
                                                    <div class="comment_container">
                                                        ...
                                                        <div class="comment-text">
                                                            ...
                                                            <p class="meta">
                                                                ...
                                                                <time itemprop="datePublished"
                                                                      datetime="2016-03-03T14:14:47+00:00">March 3, 2016
                                                                </time>
                                                                :
                                                            </p>
                                                            ...
                                                            <div itemprop="description" class="description">
                                                                <p>Pellentesque habitant morbi tristique senectus et
                                                                    ...
                                                                    Suspendisse eget facilisis odio. Duis sodales augue
                                                                    eu tincidunt faucibus. Etiam justo ligula, placerat
                                                                    ac augue id, volutpat porta dui.
                                                                </p>
                                                            </div>

                                                            <p class="meta">
                                                                <strong itemprop="author">Anna Kowalsky</strong> –
                                                                <time itemprop="datePublished"
                                                                      datetime="2016-03-03T14:14:47+00:00">March 3, 2016
                                                                </time>
                                                            </p>
                                                ...
                                                <li class="comment odd alt thread-odd thread-alt depth-1">
                                                    ...
                                                    <div class="comment_container">
                                                        ...
                                                        <div class="comment-text">
                                                            ...
                                                            <div itemprop="reviewRating" class="star-rating"
                                                                 title="Rated 5 out of 5">
                                                                <span style="width:100%"><strong itemprop="ratingValue">5</strong> out of 5</span>
                                                            </div>
                        ...
                        <div class="related products">
                            ...
                            <ul class="products columns-5">
                                ...
                                <li class="product">
                                    <div class="product-outer" style="height: 364px;">
                                        <div class="product-inner">
