...
<!-- Mirrored from transvelo.github.io/electro-html/home.html by HTTrack Website Copier/3.x [XR&CO'2014], Thu, 29 Nov 2018 13:43:09 GMT -->
<!-- Added by HTTrack -->
        ...
        <div class="container">
            ...
            <nav>
                <ul id="menu-top-bar-left" class="nav nav-inline pull-left animate-dropdown flip">
                    <li class="menu-item animate-dropdown"><a title="Welcome to Worldwide Electronics Store" href="#">Chào Mhàg {{Auth::user()->name}} Đến Mua Sắm Tại Electronics Store</a></li>
                </ul>
            </nav>
            ...
            <nav>
                <ul id="menu-top-bar-right" class="nav nav-inline pull-right animate-dropdown flip">
                    ...
                    <li class="menu-item animate-dropdown"><a title="My Account" href="{{route('page.account')}}"><i class="ec ec-user"></i>Đăng Nhập</a></li>
                </ul>
            </nav>
                    ...
                    <div class="input-group">
                        ...
                        {{--<div class="input-group-addon search-categories">--}}
                            {{--<select name='product_cat' id='product_cat' class='postform resizeselect'>--}}
                                ...
                                {{--<option value='0' selected='selected'>{{$item->ten_danh_muc_san_pham}}</option>--}}
                                {{--@endforeach--}}
                            {{--</select>--}}
                        {{--</div>--}}
...
<!-- Mirrored from transvelo.github.io/electro-html/home.html by HTTrack Website Copier/3.x [XR&CO'2014], Thu, 29 Nov 2018 13:44:18 GMT -->
</html>
