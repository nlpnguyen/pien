...
@section('content')
    <div id="content" class="site-content" tabindex="-1">
        <div class="container">
            ...
            <nav class="woocommerce-breadcrumb"><a href="<?php echo route('page.home') ?>">Home</a><span class="delimiter"><i class="fa fa-angle-right"></i></span>Cart</nav>
                            ...
                            <table class="shop_table shop_table_responsive cart">
                                ...
                                <tr class="cart_item">
                                    ...
                                    <td class="product-thumbnail">
                                        <a href="single-product.html"><img width="180" height="180" src="{{url($item->options->img)}}" alt=""></a>
                                    </td>
                                ...
                                <tr>
                                    <td class="actions" colspan="6">
                                        ...
                                        <div class="wc-proceed-to-checkout">
                                            ...
                                            <a class="checkout-button button alt wc-forward" href="<?php echo route('page.checkout') ?>">Thanh Toán</a>
                                        </div>
                            ...
                            <div class="cart_totals ">
                                ...
                                <table class="shop_table shop_table_responsive">
                                    ...
                                    <tr class="cart-subtotal">
                                        <th>Subtotal</th>
                                        <td data-title="Subtotal"><span class="amount">{{$suptotal}}</span></td>
                                    </tr>
                                    {{--<tr class="shipping">--}}
                                        {{--<th>Shipping</th>--}}
